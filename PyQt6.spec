...
Source0  : https://files.pythonhosted.org/packages/ce/bf/ff284a136b39cb1873c18e4fca4a40a8847c84a1910c5fb38c6a77868968/pyqt6-6.8.1.tar.gz
...
%prep
%setup -q -n pyqt6-6.8.1
cd %{_builddir}/pyqt6-6.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738855553
