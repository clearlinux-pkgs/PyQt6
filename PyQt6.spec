...
Source0  : https://files.pythonhosted.org/packages/8c/2b/6fe0409501798abc780a70cab48c39599742ab5a8168e682107eaab78fca/PyQt6-6.6.1.tar.gz
...
%prep
%setup -q -n PyQt6-6.6.1
cd %{_builddir}/PyQt6-6.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712170026
